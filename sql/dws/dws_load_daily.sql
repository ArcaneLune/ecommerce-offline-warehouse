-- ============================================================
-- DWS 层每日装载（增量，写入当日分区）
-- 执行：hive --hivevar dt=YYYY-mm-dd -f dws_load_daily.sql
-- ============================================================
...
-- ============================================================
INSERT OVERWRITE TABLE dws_trade_user_sku_order_1d PARTITION (dt = '${hivevar:dt}')
SELECT
    t1.user_id,
    sku.id,
    sku.sku_name,
...
-- ============================================================
INSERT OVERWRITE TABLE dws_trade_user_order_1d PARTITION (dt = '${hivevar:dt}')
SELECT
    user_id,
...
-- ============================================================
INSERT OVERWRITE TABLE dws_trade_user_cart_add_1d PARTITION (dt = '${hivevar:dt}')
SELECT
    user_id,
...
-- ============================================================
INSERT OVERWRITE TABLE dws_trade_user_payment_1d PARTITION (dt = '${hivevar:dt}')
SELECT
    user_id,
...
-- ============================================================
INSERT OVERWRITE TABLE dws_trade_province_order_1d PARTITION (dt = '${hivevar:dt}')
SELECT
    t1.province_id,
    pro.province_name,
    pro.area_code,
...
-- ============================================================
INSERT OVERWRITE TABLE dws_traffic_session_page_view_1d PARTITION (dt = '${hivevar:dt}')
SELECT
    session_id,
    mid_id,
    brand,
...
-- ============================================================
INSERT OVERWRITE TABLE dws_traffic_page_visitor_page_view_1d PARTITION (dt = '${hivevar:dt}')
SELECT
    mid_id,
    brand,
    model,
...
-- ============================================================
INSERT OVERWRITE TABLE dws_tool_coupon_used_1d PARTITION (dt = '${hivevar:dt}')
SELECT
    t1.coupon_id,
    cou.coupon_name,
    cou.coupon_type,
...
-- ============================================================
INSERT OVERWRITE TABLE dws_interaction_sku_favor_add_1d PARTITION (dt = '${hivevar:dt}')
SELECT
    t1.sku_id,
    sku.sku_name,
...
-- ============================================================
INSERT OVERWRITE TABLE dws_trade_user_sku_order_nd PARTITION (dt = '${hivevar:dt}')
SELECT
    user_id,
    sku_id,
    sku_name,
...
WHERE dt >= date_add('${hivevar:dt}', -29) AND dt <= '${hivevar:dt}'
...
SELECT
    COALESCE(nvl.user_id, t1.user_id),
    CASE
        WHEN nvl.order_date_first IS NULL THEN t1.dt
        ELSE nvl.order_date_first
    END,
    COALESCE(t1.dt, nvl.order_date_last),
    COALESCE(nvl.order_count_td, CAST(0 AS BIGINT)) + COALESCE(t1.order_count_1d, CAST(0 AS BIGINT)),
    COALESCE(nvl.order_num_td, CAST(0 AS BIGINT)) + COALESCE(t1.order_num_1d, CAST(0 AS BIGINT)),
    COALESCE(nvl.order_original_amount_td, CAST(0.0 AS DECIMAL(16,2))) + COALESCE(t1.order_original_amount_1d, CAST(0.0 AS DECIMAL(16,2))),
    COALESCE(nvl.activity_reduce_amount_td, CAST(0.0 AS DECIMAL(16,2))) + COALESCE(t1.activity_reduce_amount_1d, CAST(0.0 AS DECIMAL(16,2))),
    COALESCE(nvl.coupon_reduce_amount_td, CAST(0.0 AS DECIMAL(16,2))) + COALESCE(t1.coupon_reduce_amount_1d, CAST(0.0 AS DECIMAL(16,2))),
    COALESCE(nvl.order_total_amount_td, CAST(0.0 AS DECIMAL(16,2))) + COALESCE(t1.order_total_amount_1d, CAST(0.0 AS DECIMAL(16,2)))
FROM (
    SELECT
        user_id,
        order_date_first,
...
SELECT
    COALESCE(nvl.user_id, t1.user_id),
    COALESCE(nvl.login_date_first, t1.login_date_first),
    COALESCE(t1.login_date_last, nvl.login_date_last),
    COALESCE(nvl.login_count_td, CAST(0 AS BIGINT)) + COALESCE(t1.login_count_1d, CAST(0 AS BIGINT))
FROM (
    SELECT
        user_id,
        login_date_first,
