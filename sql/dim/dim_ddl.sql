-- ============================================================
-- DIM 层建表 DDL（8 张）
-- 执行：hive -f /opt/software/dim_ddl.sql
-- ============================================================
...
-- 5. 营销坑位维度表
CREATE TABLE IF NOT EXISTS dim_promotion_pos_full (
...
-- 6. 营销渠道维度表
CREATE TABLE IF NOT EXISTS dim_promotion_refer_full (
